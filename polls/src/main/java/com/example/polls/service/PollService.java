...
/**
 * 컨트롤러 PollController와 클래스를 UserController사용 하여
 * 클라이언트에 반환되는 페이로드 PollService형식으로 형식화된 설문 목록을 가져옵니다 .
 * PollResponse
 */
...
public class PollService {
	...
	public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
		...
		//Map Polls to PollResponses Contatining vote counts and poll create details
